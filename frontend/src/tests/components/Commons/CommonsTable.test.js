...
describe("UserTable tests", () => {
  ...
  test("Has the expected column headers and content for adminUser", () => {
    ...
    const expectedHeaders = ["id", "Name", "Cow Price", 'Milk Price', 'Starting Balance', 'Starting Date', 'Degradation Rate', 'Carrying Capacity', 'Effective Capacity', 'Capacity Per User', 'Cows', 'Show Leaderboard?'];
    const expectedFields = ["id", "name", "cowPrice", "milkPrice", "startingBalance", "startingDate", "degradationRate", "carryingCapacity", "effectiveCapacity", "capacityPerUser"];
    ...
    expect(screen.getByTestId(`${testId}-cell-row-1-col-commons.capacityPerUser`)).toHaveTextContent("6");
